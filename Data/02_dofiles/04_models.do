...
eststo clear
eststo: logit vote_incumbent i.spanish_econ_assessment_dummy opposition $sociodemo //1
eststo: logit vote_incumbent i.spanish_econ_assessment_dummy AP_index2 opposition $sociodemo //2
eststo: logit vote_incumbent  i.spanish_econ_assessment_dummy positive_partisanship //4 negative_partisanship opposition $sociodemo

eststo: logit vote_incumbent i.spanish_econ_assessment_dummy##c.AP_index2 opposition $sociodemo //3
...
eststo: logit vote_incumbent  i.spanish_econ_assessment_dummy##c.positive_partisanship negative_partisanship opposition $sociodemo //5
...
eststo: logit vote_incumbent i.spanish_econ_assessment_dummy##c.negative_partisanship positive_partisanship  opposition $sociodemo //6
...
mgroups("Likelihood of voting for the incumbent", pattern(1 0) prefix(\multicolumn{@span}{c}{) suffix(}) span erepeat(\cmidrule(lr){@span})) eqlabel(none) ///
label sfmt(%9.3g) booktabs nodep nomti nonum nogap pr2 obslast compress mlab("Baseline"  "+ Sociodemografic controls")
