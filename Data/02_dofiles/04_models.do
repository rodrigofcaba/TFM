...
* Baseline model:
eststo: logit vote_incumbent c.spanish_econ_assessment##c.AP_index if wave > 2
* + sociodemo controls
eststo: logit vote_incumbent c.spanish_econ_assessment##c.AP_index $sociodemo if wave > 2
* + attitudinal controls
eststo: logit vote_incumbent c.spanish_econ_assessment##c.AP_index $attitudinal $sociodemo if wave > 2
