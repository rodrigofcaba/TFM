...
\begin{abstract}
	\setcounter{page}{3}
	Affective polarization has become the political phenomenon of the moment. Although especially American scholars have studied thoroughly its causes, less effort has been devoted to explain its consequences. Moreover, it has been less studied in multiparty systems. In order fill this gap in the literature, I propose a causal mechanism through which affective polarization impacts political attitudes. By a process of motivated reasoning, more polarized people are expected to use their assessment of the economy to a lesser extent when they cast their votes. My main hypothesis is based on \citeposs{tilleyGovernmentBlameExperimental2011a} models of accountability, specifically I argue that the effect of affective polarization might be similar to the partisan bias effect in the selective attribution model. Thus, those who are more polarized will be less rational or, in other words, they will be less able to reward or punish the incumbent according to economic events.
	In line with part of the literature \citep*{broockmanDoesAffectivePolarization2020}, I find no effects of affective polarization on economic voting. Although affective polarization is present in the Spanish system and it is a good predictor of the likelihood of voting for the incumbent due to its correlation with ideology, individuals do not change their likelihood of voting for the incumbent according to its level of polarization and conditional on their assessment of the economy, that is, they are more ``rational'' than the theory predicts. The paper makes a methodological contribution to the extent that I propose a new way of measuring affective polarization at the individual level in multiparty systems that can be decomposed into two components. Thus, I can also study what is driving affective polarization. In that regard, incumbent's potential voters seem to be very close to their in-group with no significant effect of their out-group, whereas opposition's potential voters seem to be affected by both effects. Also, I leverage one of the latest datasets on this issue \citep*{Torcal2020} to describe the phenomenon in Spain by analyzing the affective polarization patterns fot the five main parties during a crucial period of the Spanish politics. In line with recent findings \citep*{Orriols2020,Orriols2021}, Spanish political system is polarized in a very specific way: there are two blocs of parties, one on the left side of the ideological spectrum and another one including the rest of the main parties that during the period analyzed coincide with incumbent and opposition respectively.
...
\begin{table}[H]
	...
	\input{Figures/pos-neg_oppo.tex}
